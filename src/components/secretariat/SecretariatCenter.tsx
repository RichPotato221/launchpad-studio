...
/**
 * The complete Secretarial Office, rendered inside the Secretary
 * department portal as its departmental workspace.
 */
export default function SecretariatCenter({ currentUserId }: { departmentSlug?: string; currentUserId: string }) {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h2 className="font-serif text-2xl">Secretarial Office</h2>
      ...
      <Tabs defaultValue="cockpit">
        ...
        <TabsContent value="meetings" className="pt-6">
          {currentUserId && <MeetingsModule currentUserId={currentUserId} canManage={canManage} />}
        </TabsContent>
        <TabsContent value="actions" className="pt-6"><ActionsTracker /></TabsContent>
        <TabsContent value="correspondence" className="pt-6">
          {currentUserId && <CorrespondenceModule currentUserId={currentUserId} canManage={canManage} />}
        </TabsContent>
